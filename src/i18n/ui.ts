...
export const ui = {
  nl: {
    ...
    nav: {
      ...
      leadership: "Bestuur",
      donate: "Doneren",
      switchLabel: "In het Engels bekijken",
      switchShort: "EN",
    ...
    story: {
      ...
      p2: "Ongeveer negen jaar geleden legde God een visie in haar hart: hoop en liefde brengen aan kinderen op Curaçao, in Suriname en in Nederland. Die visie werd Stichting Hope & Love Foundation.",
  ...
  en: {
    ...
    story: {
      ...
      p2: "About nine years ago, she felt God place a vision in her heart: to bring hope and love to children across Curaçao, Suriname and the Netherlands. That vision became Hope & Love Foundation.",
